        ...
        public List<MenusInfo> redis()
        {
            ...
            using (IRedisClient redisClient = RedisManager.GetClient())
            {
                ...
                if (Menus.GetAll().Count > 0)
                {
                    ...
                    List<MenusInfo> MenusToStore = new List<MenusInfo> { menus1, menus2, menus4, menus3, menus5, menus6, menus7, menus8, menus9, menus10, menus11, menus12, menus13, menus14, menus15, menus16, menus17, menus18, menus19, menus20, menus21 };
                    // 存放所有记录
