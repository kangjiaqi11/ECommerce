...
namespace Dal.XuyaDon
{
    public  class SDBHelper
    {
        ...
        private void Close()
        {
            ...
            {
                conn.Dispose();
               // ViewBag.list = new SelectList(bll.BandSel(), "Mid", "Mname");
              // @Ajax.ActionLink("删除", "Del", new { @id = m.Id }, new AjaxOptions { Confirm="确认删除吗？",UpdateTargetId = "divData" })
            }
        }
    }
}
